    ...
    <main className="py-20 md:py-28">
      <div className="container max-w-4xl mx-auto space-y-8 text-muted-foreground">
        ...
        <div className="space-y-4">
          ...
          <p>
            Welcome to Novaroof Solutions. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
          </p>
        </div>
