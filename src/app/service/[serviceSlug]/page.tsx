...
export async function generateMetadata({ params }: { params: { serviceSlug: string } }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://picsum.photos/seed/og-service/1200/630',
          width: 1200,
          height: 630,
          alt: `${service.title}`,
        },
    ...
    twitter: {
      ...
      title,
      description,
      images: ['https://picsum.photos/seed/og-service/1200/630'],
    },
  };
}
...
const getFaqs = (serviceSlug: string) => {
    const allFaqs = {
        ...
        'hail-damage-roof-repair': [
            { question: `How can I tell if I have hail damage?`, answer: `Look for dents on soft metal like gutters, vents, and AC units. On shingles, you might see dark 'bruises' where granules were knocked off. It's often hard to see from the ground, so a free, professional inspection is the safest way to know for sure.` },
        ...
        'new-roof-installation': [
            { question: `What is the process for a new roof installation?`, answer: `The process typically involves a site assessment, material selection, tear-off of any existing structure (if applicable), decking inspection, installation of underlayment and new roofing material, and a final cleanup. A professional will handle all necessary permits.` },
            { question: `How long does a new roof installation take?`, answer: `For a new construction project, the roofing phase for an average-sized home can take between 2 to 5 days, depending on the complexity, materials used, and weather conditions.` },
            { question: `What materials are best for a new roof?`, answer: `The best materials depend on your budget, desired aesthetic, and local climate. Asphalt shingles are a popular and cost-effective choice. Metal roofing offers superior durability and energy efficiency. Our network pros can walk you through the options.` },
            { question: `Do I need a permit for a new roof installation?`, answer: `Yes, in almost all cases, a building permit is required for a new roof installation. The professional contractor you hire will be responsible for securing the permit and ensuring the installation meets all local building codes.` },
        ],
        'asphalt-shingle-roofing': [
            { question: `What are the advantages of asphalt shingles?`, answer: `Asphalt shingles offer a great balance of affordability, durability, and style. They come in a wide variety of colors and designs, are easy to repair, and can last for 20-30 years with proper maintenance.` },
            ...
            { question: `Can you install asphalt shingles in any weather?`, answer: `Roofers avoid installing shingles in extreme cold, as the shingles can become brittle and their sealant strips won't activate properly. They also avoid installation during rain. The pros will schedule work during appropriate weather conditions.` },
        ],
        'roof-vent-installation': [
            { question: `Why is attic ventilation important?`, answer: `Proper ventilation helps regulate your attic's temperature. In summer, it expels hot air, reducing the load on your AC. In winter, it prevents warm, moist air from causing condensation and mold. It is crucial for both energy efficiency and the longevity of your roof structure.` },
